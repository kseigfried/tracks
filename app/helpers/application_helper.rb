...
module ApplicationHelper
  ...
  def link_to_delete_project(project, descriptor = sanitize(project.name))
    link_to(
      ...
      {:id => "delete_project_#{project.id}", :class => "delete_project_button", :title => "delete the project '#{project.name}'"}
    )
  end
  ...
  def link_to_delete_context(context, descriptor = sanitize(context.name))
    link_to(
      ...
      {:id => "delete_context_#{context.id}", :class => "delete_context_button", :title => "delete the context '#{context.name}'"}
    )
  end
